...
// import examples/threading/a_shit_actor as duckduckgoose
...
//   // Create a worker function that captures the parent_subject
//   let worker_fn = fn(_) { duckduckgoose.start(Nil, parent_subject) }
//   let game = supervisor.worker(worker_fn)
...
//           io.println("Waiting for supervisor to restart the actor...")
